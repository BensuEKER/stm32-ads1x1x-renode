 ...
 * conversion register'da 12-bit sonuc, 16-bit alanin ust kisminda sol-hizali durur. */
#define ADS1X1X_12BIT_RIGHT_SHIFT   4u

/* 12-bit ailede (ADS1014/1015) DR index -> SPS */
static const uint16_t ADS101X_DR_TABLE[8] = {
    128, 250, 490, 920, 1600, 2400, 3300, 3300
};

/* 16-bit ailede (ADS1115) DR index -> SPS */
static const uint16_t ADS111X_DR_TABLE[8] = {
    8, 16, 32, 64, 128, 250, 475, 860
};

/* PGA index -> tam skala araligi (mV), driver icinde volt donusumunde kullanilir */
static const float ADS1X1X_PGA_FSR_MV[6] = {
    6144.0f, 4096.0f, 2048.0f, 1024.0f, 512.0f, 256.0f
};
                                            ...
                                            ads1x1x_pga_t pga, float *millivolts)
{
    ...
    /* Tam skala kodu: 16-bit ailede 2^15, 12-bit ailede 2^11 (normalize edilmis raw icin). */
